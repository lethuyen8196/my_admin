...
const headCells = [
  { id: 'name', hideSortIcon: false, label: 'Tên quận/huyện' },
  { id: 'administrativeUnitCode', hideSortIcon: false, label: 'Mã quận/huyện' },
...
export default function ListDistrictManagement(props) {
  const {
    editAction,
    districtModels,
    totalItemCount,
  ...
  const handleChangePage = (event, newPage) => {
    ...
    GetListDistrict(newPage, rowsPerPage, sortExpression, userName);
  };
  ...
  const emptyRows =
    rowsPerPage -
    Math.min(rowsPerPage, districtModels.length - page * rowsPerPage);
